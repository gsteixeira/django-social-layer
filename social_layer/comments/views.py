...
from social_layer.comments.models import Comment, CommentSection, LikeComment, LikePost
...
def comment_section(request, pk=None):
    ...
    if request.method == "POST":
        ...
        comment = Comment.objects.create(
            author=sprofile, comment_section=section, text=text, reply_to=reply_to
        )
        parties = []
        if section.owner:
