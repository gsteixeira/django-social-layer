...
urlpatterns = [
    ##############
    # profile
    path("profile/", social_layer.profiles.views.setup_profile, name="setup_profile"),
    path(
        "profile/<int:pk>/",
        social_layer.profiles.views.view_profile,
        name="view_profile",
    ),
    path("community/", social_layer.profiles.views.list_profiles, name="list_profiles"),
    path(
        "social-login/", social_layer.profiles.views.social_login, name="social_login"
    ),
    path(
        "delete-profile-pic/",
    ...
    # comments
    path(
        "comments/", social_layer.comments.views.comment_section, name="comment_section"
    ),
    path(
        "comments/<int:pk>/",
        social_layer.comments.views.comment_section,
        name="comment_section",
    ),
    path(
        "reply-comment/<int:pk>/",
        social_layer.comments.views.reply_comment,
        name="reply_comment",
    ),
    path(
        "del-comment/<int:pk>/",
        social_layer.comments.views.delete_comment,
        name="delete_comment",
    ),
    # likes
    path(
        "like-comment/<int:pk>/<slug:didlike>/",
        social_layer.comments.views.like_comment,
        name="like_comment",
    ),
    path(
        "like-post/<int:pk>/<slug:didlike>/",
        social_layer.comments.views.like_post,
        name="like_post",
    ),
    # notifications
    path(
        "notifications/",
        social_layer.notifications.views.view_notifications,
        name="view_notifications",
    ),
    path(
        "notifications/adm-send/<int:pk>/",
        social_layer.notifications.views.admin_send_notification,
    ...
    path(
        "delete-post/<int:pk>/",
        social_layer.posts.views.delete_post,
        name="delete_post",
    ),
]
